...
import { TableRows, Search, Campaign, BusinessCenter,
  Person,FavoriteBorder, ChevronRight } from "@mui/icons-material";
  ...
  return (
    ...
    <div className="middle-nav-container">
      <div className="middle-nav-left">
        <img src="/assets/masterkey.png" alt="main logo element" className="logo" />
        ...
        <div className="splitBarsInputContainer">
          ...
          <div className="searchInput">
            <input type="text" placeholder='Search Courses' className="searchInputBar" />
      ...
      <div className="middle-nav-middle">
        ...
        <div className="campaignIcon">
          <Campaign className='middleNavIcons'/>
